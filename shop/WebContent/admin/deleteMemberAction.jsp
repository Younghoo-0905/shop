...
<%
	...
	int memberNo = 0;
	String adminPw = null;
	if(request.getParameter("memberNo") == null || request.getParameter("adminPw") == null) {	//	넘어온 memberNo 값이 있으면
	...
	if(value) {		//	메서드의 반환값이 true이면 회원강제탈퇴 실행
		...
		response.sendRedirect(request.getContextPath() + "/admin/deleteMemberForm.jsp?memberNo=" + memberNo + "&adminPw=" + adminPw);
	}
